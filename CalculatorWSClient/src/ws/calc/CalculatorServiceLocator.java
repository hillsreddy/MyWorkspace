...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements ws.calc.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8008/CalculatorWS/services/Calculator";
    ...
    public ws.calc.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.calc.CalculatorSoapBindingStub _stub = new ws.calc.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.calc.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.calc.CalculatorSoapBindingStub _stub = new ws.calc.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calc.ws", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calc.ws", "Calculator"));
        }
