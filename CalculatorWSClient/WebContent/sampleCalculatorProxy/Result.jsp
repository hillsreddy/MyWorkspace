...
<jsp:useBean id="sampleCalculatorProxyid" scope="session" class="ws.calc.CalculatorProxy" />
<%
...
case 10:
        gotMethod = true;
        ws.calc.Calculator getCalculator10mtemp = sampleCalculatorProxyid.getCalculator();
...
case 27:
        ...
        int multiply27mtemp = sampleCalculatorProxyid.multiply(a_5idTemp,b_6idTemp);
...
case 34:
        ...
        int subtract34mtemp = sampleCalculatorProxyid.subtract(a_7idTemp,b_8idTemp);
